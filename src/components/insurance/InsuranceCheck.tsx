              ...
              <ul className="list-disc">
                {errors.map((e) => {
                  ...
                  if (e === "INSURANCE_STATE_NOT_ACCEPTED" || e === "INSURANCE_TYPE_NOT_ACCEPTED" || e === "INSURANCE_NO_PROVIDERS") {
                    return <li>Unfortunately, we dont accept your insurance at this time. <Link href={`/signup/checkout/${checkoutId}`} className="font-bold text-brand-berry">Click here to continue without insurance.</Link></li>
                  }
