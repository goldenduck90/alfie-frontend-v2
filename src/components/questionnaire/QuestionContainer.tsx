...
export function QuestionContainer(props: QuestionContainerProps) {
  return (
    <div className="flex flex-col border rounded-xl py-8 px-8 bg-white max-w-[612px] w-full relative">
      ...
      <div className="grid grid-cols-12 gap-x-6">{props.children}</div>
    </div>
  );
}
